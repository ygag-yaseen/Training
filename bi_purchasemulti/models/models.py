...
#multi company concept to create a purchase order from one company then auotomatically created a sale order from another company
...
class createpurchaseorder(models.TransientModel):
	...
	def action_create_purchase_order(self):
		...
		purchase = purchase_res.create({
						'partner_id' : self.mycompany_id.partner_id.id,
